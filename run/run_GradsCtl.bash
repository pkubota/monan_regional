...
# !CALLING SEQUENCE:
#     
#   ./run_GradsCtl.bash  ${EXP_NAME} ${EXP_RES}   ${LABELI}  ${LABELF}  ${Domain}  ${AreaRegion}  ${TypeGrid}
#
#
# For GFS datasets
#
#        ./run_GradsCtl.bash  GFS 535554   2024042700  2024050100  regional  PortoAlegre  variable_resolution
#
...
#EOC
function usage(){
   sed -n '/^# !CALLING SEQUENCE:/,/^# !/{p}' ./run_GradsCtl.bash | head -n -1
}
...
echo -e  "${GREEN}==>${NC} Creating submition scripts run_GradsCtl, atmosphere_model...\n"
